                        ...
                        Container(
                          ...
                          child: TextButtonWidget(
                            ...
                            onPressed: () async {
                              ...
                              progressHUD!.show();
                              final companyData = await companyInfUpdateJsnFunc(1, teCompanyName.text, base64Image != null ? base64Image : null,
                                  teTel1.text, teTel2.text, teGoogleAddress.text, teEPosta.text, teWeb.text);

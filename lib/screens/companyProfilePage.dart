          ...
          builder: (context) => BackGroundContainer(
            child: Column(
              children: [
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(overflow: TextOverflow.fade, fontFamily: contentFont, fontSize: 20, color: Colors.white),
                            ),
                          ),
                        ],
                      ),
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(
                                ...
                                child: Center(
                                    child: Text(companyProfile!.result!.companyName!, style: TextStyle(color: white), overflow: TextOverflow.fade))),
                          ],
                        ),
                      ),
                      Row(
                ...
                Expanded(
                  child: Container(
                    decoration: BoxDecoration(borderRadius: BorderRadius.vertical(top: Radius.circular(cardCurved)), color: white),

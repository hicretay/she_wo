// ignore_for_file: unnecessary_null_comparison, must_be_immutable, avoid_print, library_private_types_in_public_api
import 'dart:convert';
import 'dart:io';
  ...
  String getStartDate() {
    if (startDate == null) {
      ...
      String formattedStartDate =
          "${startDate!.day <= 9 ? "0${startDate!.day}" : startDate!.day.toString()}.${startDate!.month <= 9 ? "0${startDate!.month}" : startDate!.month.toString()}.${startDate!.year}";
      setState(() {
                                        ...
                                        child: AspectRatio(
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                                ...
                                                image: DecorationImage(fit: BoxFit.fitWidth, image: NetworkImage(widget.pictures![index].cPicture!))),
                                            child: Align(
                                ...
                                child: TextButtonWidget(
                                  ...
                                  onPressed: () async {
                                    ...
                                    final addCampaignData = await campaignAddJsnFunc(
                                        1, 1, getStartDate(), getFinishedDate(), teLeading.text, teContent.text, base64imagesList);

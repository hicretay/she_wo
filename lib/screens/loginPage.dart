                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                            ...
                            child: Center(
                                child:
                                    SvgPicture.asset("assets/images/logobeyaz.svg", color: white, placeholderBuilder: (context) => circularBasic))),
                      ),
                      //------------------------------------------------------------------
                      ...
                      SingleChildScrollView(
                        child: Column(children: [
                                  ...
                                  if (username != "" && password != "") {
                                    ...
                                    if (userData!.success == true) {
                                      ...
                                      Navigator.pushAndRemoveUntil(
                                          context, MaterialPageRoute(builder: (context) => LocationPage()), (route) => false);
                          ...
                          //SizedBox(height: deviceHeight(context)*0.05),
                          Padding(
                            padding: const EdgeInsets.only(right: defaultPadding * 2, left: defaultPadding * 2, bottom: minSpace),
                            child: Container(
                              decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(30.0)), color: primaryColor),
                              //--------------------------------------UYE OLMADAN DEVAM ET BUTONU---------------------------------------------
                              child: TextButton(
                                style: ButtonStyle(),
                                child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                                  Text("Üye olmadan devam et", style: TextStyle(color: darkWhite, fontSize: 15, fontFamily: contentFont)),

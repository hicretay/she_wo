...
import 'package:she_wo/screens/companyProfilePage.dart';
                                ...
                                return HomeContainerWidget(
                                  ...
                                  onPressed: () async {
                                    ...
                                    final ContentStreamDetailJsn? homeDetailContent = await contentStreamDetailJsnFunc(
                                        favoriContent![index].companyId, favoriContent![index].campaingId, userIdData!);
                                    // "Detaylı Bilgi İçin" butouna basıldığında detay sayfasına yönlendirecek
                                    Navigator.of(context, rootNavigator: true).push(MaterialPageRoute(
                                        builder: (context) => HomeDetailPage(
                                            homeDetailContent: homeDetailContent?.result,
                                            campaingId: favoriContent![index].campaingId,
                                            companyId: favoriContent![index].companyId,
                                            companyLogo: favoriContent![index].companyLogo,
                                            companyName: favoriContent![index].companyName,
                                            contentTitle: favoriContent![index].contentTitle,
                                            companyPhone: favoriContent![index].companyPhone.toString())));
                                    progressUHD.dismiss();
                                  },
                                  //--------------------------------------------------------------------------------------------------------------------
                                  //-----------------------------------------------KONUM ICONBUTTON'I----------------------------------------------------
                                  onPressedLocation: () {
                                    ...
                                    Navigator.of(context, rootNavigator: true).push(
                                        MaterialPageRoute(builder: (context) => WebViewWidget(locationUrl: favoriContent![index].googleAdressLink)));
                                    progressHUD.dismiss();
                                  },
                                  //-------------------------------------------------------------------------------------------------------------------
                                  //---------------------------------------------LİKE BUTTON------------------------------------------------------
                                  likeButton: IconButton(
                                      icon: favoriContent![index].liked
                                          ? SvgPicture.asset("assets/icons/heart-focus.svg", height: 22, width: 22, color: primaryColor)

...
class TextButtonWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(maxSpace)), color: primaryColor),
        child: TextButton(
          style: ButtonStyle(),
          child: icon == null
              ? Text(buttonText!, style: TextStyle(color: darkWhite, fontSize: 15, fontFamily: contentFont))

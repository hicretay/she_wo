...
TextStyle reservationText(BuildContext context) {
  return const TextStyle(fontFamily: leadingFont, fontSize: 17);
}

const primaryColor = Colors.white; //Color(0xFF141414); #0F0F1E Ana zemin rengi
const primaryTransparentColor = Color(0x80352A4D);
const secondaryColor = Color(0xFFf3f3f3);
